    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "Book Now", fontSize = 30.sp, color = Color.White)
                },
                navigationIcon = {
                    IconButton(onClick = {
        ...
        content = {
            LazyColumn(
                ...
                item {
                    ...
                    if (productNameError) {
                        Text("Service Name is required", color = Color.Red)
                    }
                    if (productDescriptionError) {
                        Text("Date is required", color = Color.Red)
                    }
                    if (productPriceError) {
                        Text("Time is required", color = Color.Red)
                    }
